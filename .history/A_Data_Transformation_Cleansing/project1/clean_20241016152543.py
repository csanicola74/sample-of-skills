...
# Load the dataset
df = pd.read_csv(
    "D:/GitHub/sample-of-skills/A_Data_Transformation_Cleansing/project1/data/healthcare_claims_sample.csv")
...
# - Ensure all dates in 'Claim Date' and 'Payment Date' columns are in a consistent format (e.g., %Y-%m-%d)
